...
class SmoothingRun {
    ...
    public void run(String[] args) {
      //  String filename = "home/vardan/Pictures/test2.png";
        //src = Imgcodecs.imread(filename, Imgcodecs.IMREAD_COLOR);
    	src=Imgcodecs.imread("/home/vardan/Pictures/test2.png");
        if( src.empty() ) {
            System.out.println("Error opening image");
            System.out.println("Usage: ./Smoothing [image_name __/Pictures/test2.png] \n");
            System.exit(-1);
        }
